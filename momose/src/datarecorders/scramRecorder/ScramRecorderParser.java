...
public class ScramRecorderParser extends DefaultHandler
 {
  ...
  public ScramRecorderParser()
   {
	filePath="."+File.separator+"scramRecorderOutput.xml";
