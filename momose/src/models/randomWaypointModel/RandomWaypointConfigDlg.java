...
public class RandomWaypointConfigDlg extends ModelConfigDlg
{
 protected JSpinner spinnerVMin;
 protected JSpinner spinnerVMax;
 protected JSpinner spinnerPauseTime;	
	
 public RandomWaypointConfigDlg()
  {
	setSize(370,220);  
	setTitle("Random waypoint model config dialog");
  }//Fine costruttore
 ...
 public JPanel createRandomWalkPanel()
  {
   ...
   //interval time panel
	JPanel pauseTimePanel=new JPanel(new FlowLayout());
	randomWalkPanel.add(pauseTimePanel);
	
	pauseTimePanel.add(new JLabel("Pause time:"));
	...
	pauseTimePanel.add(spinnerPauseTime);
