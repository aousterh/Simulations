...
public class MessageModelConfigDlg extends ModelConfigDlg
{
    protected JSpinner spinnerVMin;
    protected JSpinner spinnerVMax;
    protected JSpinner spinnerPauseTime; 
    
    public MessageModelConfigDlg(String name)
    {
        setSize(350,220);  
    ...
    }//Fine createMessageModelPanel
    
}//Fine classe MessageModelConfigDlg